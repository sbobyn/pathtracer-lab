...
- `earth-blue-marble.jpg` is a NASA Blue Marble world map, converted from BMP to JPEG for the web. Source collection: https://visibleearth.nasa.gov/collection/1484/blue-marble
