...
struct Material { int model; int baseColorTextureId; int emissionTextureId; vec3 baseColorFactor; vec3 emissionFactor; float roughness; float ior; float emissionStrength; bool emissionTwoSided; };
struct Surface { vec3 baseColor; vec3 emission; vec3 shadingNormal; };
